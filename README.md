...
## Output
The output of GCAM runs include a database (in .basex) per scenario. The visiualization of the results is archived at [realxinzhao/paper-LandBasedCDR-DisplayItems](https://github.com/realxinzhao/paper-LandBasedCDR-GCAM).
